...
func Query_setAllTypeB() *gol.Query {
	...
	query.SetOrderBy("count(", &test.TableItem1.Id, ") desc")
...
func TestQuery_GetInsertSelectQuery(t *testing.T) {
	t.Run("insert a", func(t *testing.T) {
		query := Query_setAllTypeA()

		str, valueList, err := query.GetInsertSelectQuery()
		if err != nil {
			t.Error(err)
			return
		}
		...
		{
			target := str
			check := `INSERT INTO "item" ("create_at", "update_at", "delete_at", "str") SELECT "t0"."id", "t0"."str", "t1".* FROM "item" as "t1", "PUBLIC"."TAG" as "t2" INNER JOIN "item" as "t3" ON "t3"."id" = "t0"."id" AND 1 = 1 AND "t3"."id" = ? AND "t3"."id" != ? AND "t3"."str" LIKE ? AND "t3"."str" NOT LIKE ? AND "t3"."id" IN (?, ?, ?) AND "t3"."id" NOT IN (?, ?, ?) AND "t3"."id" > ? AND "t3"."id" >= ? AND "t3"."id" < ? AND "t3"."id" <= ? AND ( 1 = 1 OR "t3"."id" = ? OR "t3"."id" != ? OR "t3"."str" LIKE ? OR "t3"."str" NOT LIKE ? OR "t3"."id" IN (?, ?, ?) OR "t3"."id" NOT IN (?, ?, ?) OR "t3"."id" > ? OR "t3"."id" >= ? OR "t3"."id" < ? OR "t3"."id" <= ? ) OR ( 1 = 1 ) LEFT JOIN "PUBLIC"."TAG" as "t4" ON "t4"."ID" = "t0"."id" RIGHT JOIN "PUBLIC"."TAG" as "t5" ON "t5"."ID" = "t0"."id" WHERE 1 = 1 AND "t0"."id" = ? AND "t0"."id" != ? AND "t0"."str" LIKE ? AND "t0"."str" NOT LIKE ? AND "t0"."id" IN (?, ?, ?) AND "t0"."id" NOT IN (?, ?, ?) AND "t0"."id" > ? AND "t0"."id" >= ? AND "t0"."id" < ? AND "t0"."id" <= ? AND ( 1 = 1 OR "t0"."id" = ? OR "t0"."id" != ? OR "t0"."str" LIKE ? OR "t0"."str" NOT LIKE ? OR "t0"."id" IN (?, ?, ?) OR "t0"."id" NOT IN (?, ?, ?) OR "t0"."id" > ? OR "t0"."id" >= ? OR "t0"."id" < ? OR "t0"."id" <= ? ) OR ( 1 = 1 ) GROUP BY "t0"."id", "t0"."id", "t0"."id" HAVING 1 = 1 AND "t0"."id" = ? AND "t0"."id" != ? AND "t0"."str" LIKE ? AND "t0"."str" NOT LIKE ? AND "t0"."id" IN (?, ?, ?) AND "t0"."id" NOT IN (?, ?, ?) AND "t0"."id" > ? AND "t0"."id" >= ? AND "t0"."id" < ? AND "t0"."id" <= ? AND ( 1 = 1 OR "t0"."id" = ? OR "t0"."id" != ? OR "t0"."str" LIKE ? OR "t0"."str" NOT LIKE ? OR "t0"."id" IN (?, ?, ?) OR "t0"."id" NOT IN (?, ?, ?) OR "t0"."id" > ? OR "t0"."id" >= ? OR "t0"."id" < ? OR "t0"."id" <= ? ) OR ( 1 = 1 ) ORDER BY "t0"."id", "t0"."id" LIMIT 10 OFFSET 20`
			if target != check {
				t.Errorf("\ntarget: %v\ncheck : %v", target, check)
			}
		}
	...
	t.Run("insert b", func(t *testing.T) {
		...
		{
			target := str
			check := `INSERT INTO "item" ("create_at", "update_at", "delete_at", "str") SELECT count("t0"."id"), count("t0"."str"), "t1".* FROM "item" as "t1", "PUBLIC"."TAG" as "t2" INNER JOIN "item" as "t3" ON "t3"."id" = "t0"."id" AND count("t3"."id") = count("t3"."id") AND count("t3"."id") = "t3"."id" AND count("t3"."id") != "t3"."id" AND count("t3"."str") LIKE ? AND count("t3"."str") NOT LIKE ? AND count("t3"."id") IN (?, ?, ?) AND count("t3"."id") NOT IN (?, ?, ?) AND count("t3"."id") > "t3"."id" AND count("t3"."id") >= "t3"."id" AND count("t3"."id") < "t3"."id" AND count("t3"."id") <= "t3"."id" AND ( count("t3"."id") = count("t3"."id") OR count("t3"."id") = "t3"."id" OR count("t3"."id") != "t3"."id" OR count("t3"."str") LIKE ? OR count("t3"."str") NOT LIKE ? OR count("t3"."id") IN (?, ?, ?) OR count("t3"."id") NOT IN (?, ?, ?) OR count("t3"."id") > "t3"."id" OR count("t3"."id") >= "t3"."id" OR count("t3"."id") < "t3"."id" OR count("t3"."id") <= "t3"."id" ) OR ( count("t3"."id") = count("t3"."id") ) LEFT JOIN "PUBLIC"."TAG" as "t4" ON "t4"."ID" = "t0"."id" RIGHT JOIN "PUBLIC"."TAG" as "t5" ON "t5"."ID" = "t0"."id" WHERE count("t1"."id") = count("t1"."id") AND count("t0"."id") = "t0"."id" AND count("t0"."id") != "t0"."id" AND count("t0"."str") LIKE ? AND count("t0"."str") NOT LIKE ? AND count("t0"."id") IN (?, ?, ?) AND count("t0"."id") NOT IN (?, ?, ?) AND count("t0"."id") > "t0"."id" AND count("t0"."id") >= "t0"."id" AND count("t0"."id") < "t0"."id" AND count("t0"."id") <= "t0"."id" AND ( count("t1"."id") = count("t1"."id") OR count("t0"."id") = "t0"."id" OR count("t0"."id") != "t0"."id" OR count("t0"."str") LIKE ? OR count("t0"."str") NOT LIKE ? OR count("t0"."id") IN (?, ?, ?) OR count("t0"."id") NOT IN (?, ?, ?) OR count("t0"."id") > "t0"."id" OR count("t0"."id") >= "t0"."id" OR count("t0"."id") < "t0"."id" OR count("t0"."id") <= "t0"."id" ) OR ( count("t1"."id") = count("t1"."id") ) GROUP BY count("t0"."id"), count("t0"."id"), count("t0"."id") HAVING count("t1"."id") = count("t1"."id") AND count("t0"."id") = "t0"."id" AND count("t0"."id") != "t0"."id" AND count("t0"."str") LIKE ? AND count("t0"."str") NOT LIKE ? AND count("t0"."id") IN (?, ?, ?) AND count("t0"."id") NOT IN (?, ?, ?) AND count("t0"."id") > "t0"."id" AND count("t0"."id") >= "t0"."id" AND count("t0"."id") < "t0"."id" AND count("t0"."id") <= "t0"."id" AND ( count("t1"."id") = count("t1"."id") OR count("t0"."id") = "t0"."id" OR count("t0"."id") != "t0"."id" OR count("t0"."str") LIKE ? OR count("t0"."str") NOT LIKE ? OR count("t0"."id") IN (?, ?, ?) OR count("t0"."id") NOT IN (?, ?, ?) OR count("t0"."id") > "t0"."id" OR count("t0"."id") >= "t0"."id" OR count("t0"."id") < "t0"."id" OR count("t0"."id") <= "t0"."id" ) OR ( count("t1"."id") = count("t1"."id") ) ORDER BY count("t0"."id"), count("t0"."id") desc LIMIT 10 OFFSET 20`
			if target != check {
				t.Errorf("\ntarget: %v\ncheck : %v", target, check)
			}
		}
...
func TestQuery_GetSelectQuery(t *testing.T) {
	t.Run("select a", func(t *testing.T) {
		...
		{
			target := str
			check := `SELECT "t0"."id", "t0"."str", "t1".* FROM "item" as "t0", "item" as "t1", "PUBLIC"."TAG" as "t2" INNER JOIN "item" as "t3" ON "t3"."id" = "t0"."id" AND 1 = 1 AND "t3"."id" = ? AND "t3"."id" != ? AND "t3"."str" LIKE ? AND "t3"."str" NOT LIKE ? AND "t3"."id" IN (?, ?, ?) AND "t3"."id" NOT IN (?, ?, ?) AND "t3"."id" > ? AND "t3"."id" >= ? AND "t3"."id" < ? AND "t3"."id" <= ? AND ( 1 = 1 OR "t3"."id" = ? OR "t3"."id" != ? OR "t3"."str" LIKE ? OR "t3"."str" NOT LIKE ? OR "t3"."id" IN (?, ?, ?) OR "t3"."id" NOT IN (?, ?, ?) OR "t3"."id" > ? OR "t3"."id" >= ? OR "t3"."id" < ? OR "t3"."id" <= ? ) OR ( 1 = 1 ) LEFT JOIN "PUBLIC"."TAG" as "t4" ON "t4"."ID" = "t0"."id" RIGHT JOIN "PUBLIC"."TAG" as "t5" ON "t5"."ID" = "t0"."id" WHERE 1 = 1 AND "t0"."id" = ? AND "t0"."id" != ? AND "t0"."str" LIKE ? AND "t0"."str" NOT LIKE ? AND "t0"."id" IN (?, ?, ?) AND "t0"."id" NOT IN (?, ?, ?) AND "t0"."id" > ? AND "t0"."id" >= ? AND "t0"."id" < ? AND "t0"."id" <= ? AND ( 1 = 1 OR "t0"."id" = ? OR "t0"."id" != ? OR "t0"."str" LIKE ? OR "t0"."str" NOT LIKE ? OR "t0"."id" IN (?, ?, ?) OR "t0"."id" NOT IN (?, ?, ?) OR "t0"."id" > ? OR "t0"."id" >= ? OR "t0"."id" < ? OR "t0"."id" <= ? ) OR ( 1 = 1 ) GROUP BY "t0"."id", "t0"."id", "t0"."id" HAVING 1 = 1 AND "t0"."id" = ? AND "t0"."id" != ? AND "t0"."str" LIKE ? AND "t0"."str" NOT LIKE ? AND "t0"."id" IN (?, ?, ?) AND "t0"."id" NOT IN (?, ?, ?) AND "t0"."id" > ? AND "t0"."id" >= ? AND "t0"."id" < ? AND "t0"."id" <= ? AND ( 1 = 1 OR "t0"."id" = ? OR "t0"."id" != ? OR "t0"."str" LIKE ? OR "t0"."str" NOT LIKE ? OR "t0"."id" IN (?, ?, ?) OR "t0"."id" NOT IN (?, ?, ?) OR "t0"."id" > ? OR "t0"."id" >= ? OR "t0"."id" < ? OR "t0"."id" <= ? ) OR ( 1 = 1 ) ORDER BY "t0"."id", "t0"."id" LIMIT 10 OFFSET 20`
			if target != check {
				t.Errorf("\ntarget: %v\ncheck : %v", target, check)
			}
		}
	...
	t.Run("select b", func(t *testing.T) {
		...
		{
			target := str
			check := `SELECT count("t0"."id"), count("t0"."str"), "t1".* FROM "item" as "t0", "item" as "t1", "PUBLIC"."TAG" as "t2" INNER JOIN "item" as "t3" ON "t3"."id" = "t0"."id" AND count("t3"."id") = count("t3"."id") AND count("t3"."id") = "t3"."id" AND count("t3"."id") != "t3"."id" AND count("t3"."str") LIKE ? AND count("t3"."str") NOT LIKE ? AND count("t3"."id") IN (?, ?, ?) AND count("t3"."id") NOT IN (?, ?, ?) AND count("t3"."id") > "t3"."id" AND count("t3"."id") >= "t3"."id" AND count("t3"."id") < "t3"."id" AND count("t3"."id") <= "t3"."id" AND ( count("t3"."id") = count("t3"."id") OR count("t3"."id") = "t3"."id" OR count("t3"."id") != "t3"."id" OR count("t3"."str") LIKE ? OR count("t3"."str") NOT LIKE ? OR count("t3"."id") IN (?, ?, ?) OR count("t3"."id") NOT IN (?, ?, ?) OR count("t3"."id") > "t3"."id" OR count("t3"."id") >= "t3"."id" OR count("t3"."id") < "t3"."id" OR count("t3"."id") <= "t3"."id" ) OR ( count("t3"."id") = count("t3"."id") ) LEFT JOIN "PUBLIC"."TAG" as "t4" ON "t4"."ID" = "t0"."id" RIGHT JOIN "PUBLIC"."TAG" as "t5" ON "t5"."ID" = "t0"."id" WHERE count("t1"."id") = count("t1"."id") AND count("t0"."id") = "t0"."id" AND count("t0"."id") != "t0"."id" AND count("t0"."str") LIKE ? AND count("t0"."str") NOT LIKE ? AND count("t0"."id") IN (?, ?, ?) AND count("t0"."id") NOT IN (?, ?, ?) AND count("t0"."id") > "t0"."id" AND count("t0"."id") >= "t0"."id" AND count("t0"."id") < "t0"."id" AND count("t0"."id") <= "t0"."id" AND ( count("t1"."id") = count("t1"."id") OR count("t0"."id") = "t0"."id" OR count("t0"."id") != "t0"."id" OR count("t0"."str") LIKE ? OR count("t0"."str") NOT LIKE ? OR count("t0"."id") IN (?, ?, ?) OR count("t0"."id") NOT IN (?, ?, ?) OR count("t0"."id") > "t0"."id" OR count("t0"."id") >= "t0"."id" OR count("t0"."id") < "t0"."id" OR count("t0"."id") <= "t0"."id" ) OR ( count("t1"."id") = count("t1"."id") ) GROUP BY count("t0"."id"), count("t0"."id"), count("t0"."id") HAVING count("t1"."id") = count("t1"."id") AND count("t0"."id") = "t0"."id" AND count("t0"."id") != "t0"."id" AND count("t0"."str") LIKE ? AND count("t0"."str") NOT LIKE ? AND count("t0"."id") IN (?, ?, ?) AND count("t0"."id") NOT IN (?, ?, ?) AND count("t0"."id") > "t0"."id" AND count("t0"."id") >= "t0"."id" AND count("t0"."id") < "t0"."id" AND count("t0"."id") <= "t0"."id" AND ( count("t1"."id") = count("t1"."id") OR count("t0"."id") = "t0"."id" OR count("t0"."id") != "t0"."id" OR count("t0"."str") LIKE ? OR count("t0"."str") NOT LIKE ? OR count("t0"."id") IN (?, ?, ?) OR count("t0"."id") NOT IN (?, ?, ?) OR count("t0"."id") > "t0"."id" OR count("t0"."id") >= "t0"."id" OR count("t0"."id") < "t0"."id" OR count("t0"."id") <= "t0"."id" ) OR ( count("t1"."id") = count("t1"."id") ) ORDER BY count("t0"."id"), count("t0"."id") desc LIMIT 10 OFFSET 20`
			if target != check {
				t.Errorf("\ntarget: %v\ncheck : %v", target, check)
			}
		}
...
func TestQuery_GetSelectCountQuery(t *testing.T) {
	t.Run("select a", func(t *testing.T) {
		...
		{
			target := str
			check := `SELECT count(*) as count FROM "item" as "t0", "item" as "t1", "PUBLIC"."TAG" as "t2" INNER JOIN "item" as "t3" ON "t3"."id" = "t0"."id" AND 1 = 1 AND "t3"."id" = ? AND "t3"."id" != ? AND "t3"."str" LIKE ? AND "t3"."str" NOT LIKE ? AND "t3"."id" IN (?, ?, ?) AND "t3"."id" NOT IN (?, ?, ?) AND "t3"."id" > ? AND "t3"."id" >= ? AND "t3"."id" < ? AND "t3"."id" <= ? AND ( 1 = 1 OR "t3"."id" = ? OR "t3"."id" != ? OR "t3"."str" LIKE ? OR "t3"."str" NOT LIKE ? OR "t3"."id" IN (?, ?, ?) OR "t3"."id" NOT IN (?, ?, ?) OR "t3"."id" > ? OR "t3"."id" >= ? OR "t3"."id" < ? OR "t3"."id" <= ? ) OR ( 1 = 1 ) LEFT JOIN "PUBLIC"."TAG" as "t4" ON "t4"."ID" = "t0"."id" RIGHT JOIN "PUBLIC"."TAG" as "t5" ON "t5"."ID" = "t0"."id" WHERE 1 = 1 AND "t0"."id" = ? AND "t0"."id" != ? AND "t0"."str" LIKE ? AND "t0"."str" NOT LIKE ? AND "t0"."id" IN (?, ?, ?) AND "t0"."id" NOT IN (?, ?, ?) AND "t0"."id" > ? AND "t0"."id" >= ? AND "t0"."id" < ? AND "t0"."id" <= ? AND ( 1 = 1 OR "t0"."id" = ? OR "t0"."id" != ? OR "t0"."str" LIKE ? OR "t0"."str" NOT LIKE ? OR "t0"."id" IN (?, ?, ?) OR "t0"."id" NOT IN (?, ?, ?) OR "t0"."id" > ? OR "t0"."id" >= ? OR "t0"."id" < ? OR "t0"."id" <= ? ) OR ( 1 = 1 ) GROUP BY "t0"."id", "t0"."id", "t0"."id" HAVING 1 = 1 AND "t0"."id" = ? AND "t0"."id" != ? AND "t0"."str" LIKE ? AND "t0"."str" NOT LIKE ? AND "t0"."id" IN (?, ?, ?) AND "t0"."id" NOT IN (?, ?, ?) AND "t0"."id" > ? AND "t0"."id" >= ? AND "t0"."id" < ? AND "t0"."id" <= ? AND ( 1 = 1 OR "t0"."id" = ? OR "t0"."id" != ? OR "t0"."str" LIKE ? OR "t0"."str" NOT LIKE ? OR "t0"."id" IN (?, ?, ?) OR "t0"."id" NOT IN (?, ?, ?) OR "t0"."id" > ? OR "t0"."id" >= ? OR "t0"."id" < ? OR "t0"."id" <= ? ) OR ( 1 = 1 ) ORDER BY "t0"."id", "t0"."id" LIMIT 10 OFFSET 20`
			if target != check {
				t.Errorf("\ntarget: %v\ncheck : %v", target, check)
			}
		}
	...
	t.Run("select b", func(t *testing.T) {
		...
		{
			target := str
			check := `SELECT count(*) as count FROM "item" as "t0", "item" as "t1", "PUBLIC"."TAG" as "t2" INNER JOIN "item" as "t3" ON "t3"."id" = "t0"."id" AND count("t3"."id") = count("t3"."id") AND count("t3"."id") = "t3"."id" AND count("t3"."id") != "t3"."id" AND count("t3"."str") LIKE ? AND count("t3"."str") NOT LIKE ? AND count("t3"."id") IN (?, ?, ?) AND count("t3"."id") NOT IN (?, ?, ?) AND count("t3"."id") > "t3"."id" AND count("t3"."id") >= "t3"."id" AND count("t3"."id") < "t3"."id" AND count("t3"."id") <= "t3"."id" AND ( count("t3"."id") = count("t3"."id") OR count("t3"."id") = "t3"."id" OR count("t3"."id") != "t3"."id" OR count("t3"."str") LIKE ? OR count("t3"."str") NOT LIKE ? OR count("t3"."id") IN (?, ?, ?) OR count("t3"."id") NOT IN (?, ?, ?) OR count("t3"."id") > "t3"."id" OR count("t3"."id") >= "t3"."id" OR count("t3"."id") < "t3"."id" OR count("t3"."id") <= "t3"."id" ) OR ( count("t3"."id") = count("t3"."id") ) LEFT JOIN "PUBLIC"."TAG" as "t4" ON "t4"."ID" = "t0"."id" RIGHT JOIN "PUBLIC"."TAG" as "t5" ON "t5"."ID" = "t0"."id" WHERE count("t1"."id") = count("t1"."id") AND count("t0"."id") = "t0"."id" AND count("t0"."id") != "t0"."id" AND count("t0"."str") LIKE ? AND count("t0"."str") NOT LIKE ? AND count("t0"."id") IN (?, ?, ?) AND count("t0"."id") NOT IN (?, ?, ?) AND count("t0"."id") > "t0"."id" AND count("t0"."id") >= "t0"."id" AND count("t0"."id") < "t0"."id" AND count("t0"."id") <= "t0"."id" AND ( count("t1"."id") = count("t1"."id") OR count("t0"."id") = "t0"."id" OR count("t0"."id") != "t0"."id" OR count("t0"."str") LIKE ? OR count("t0"."str") NOT LIKE ? OR count("t0"."id") IN (?, ?, ?) OR count("t0"."id") NOT IN (?, ?, ?) OR count("t0"."id") > "t0"."id" OR count("t0"."id") >= "t0"."id" OR count("t0"."id") < "t0"."id" OR count("t0"."id") <= "t0"."id" ) OR ( count("t1"."id") = count("t1"."id") ) GROUP BY count("t0"."id"), count("t0"."id"), count("t0"."id") HAVING count("t1"."id") = count("t1"."id") AND count("t0"."id") = "t0"."id" AND count("t0"."id") != "t0"."id" AND count("t0"."str") LIKE ? AND count("t0"."str") NOT LIKE ? AND count("t0"."id") IN (?, ?, ?) AND count("t0"."id") NOT IN (?, ?, ?) AND count("t0"."id") > "t0"."id" AND count("t0"."id") >= "t0"."id" AND count("t0"."id") < "t0"."id" AND count("t0"."id") <= "t0"."id" AND ( count("t1"."id") = count("t1"."id") OR count("t0"."id") = "t0"."id" OR count("t0"."id") != "t0"."id" OR count("t0"."str") LIKE ? OR count("t0"."str") NOT LIKE ? OR count("t0"."id") IN (?, ?, ?) OR count("t0"."id") NOT IN (?, ?, ?) OR count("t0"."id") > "t0"."id" OR count("t0"."id") >= "t0"."id" OR count("t0"."id") < "t0"."id" OR count("t0"."id") <= "t0"."id" ) OR ( count("t1"."id") = count("t1"."id") ) ORDER BY count("t0"."id"), count("t0"."id") desc LIMIT 10 OFFSET 20`
			if target != check {
				t.Errorf("\ntarget: %v\ncheck : %v", target, check)
			}
		}
