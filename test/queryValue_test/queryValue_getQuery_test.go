...
func TestQueryValue_GetInsertSelectQuery(t *testing.T) {
	tableItem1 := test.Item{}
	tableItem2 := test.Item{}
	tableItem3 := test.Item{}
	tableItem4 := test.Item{}
	...
	fn := func(t *testing.T, tableList [][]interface{}, fromList [][]interface{}, joinList [][][]interface{}, joinWhereList [][]interface{}, valuesColumnList [][]interface{}, valuesList [][]interface{}, conflictList [][]interface{}, setList [][]interface{}, selectList [][]interface{}, whereList [][]interface{}, groupByList [][]interface{}, havingList [][]interface{}, orderByList [][]interface{}, limit int, offset int, checkList []string) {
		...
		query, valueList, err := queryValue.GetInsertSelectQuery()
		if err != nil {
			t.Error(err)
			return
		}
	...
	t.Run("default", func(t *testing.T) {
		...
		offset := 100
		checkList := []string{
			`INSERT INTO "item" ("id", "str") SELECT count("t0"."id"), "t0"."str" FROM "item" as "t1", "item" as "t2" INNER JOIN "item" as "t3" ON "t3"."id" = "t0"."id" AND "t3"."id" = ? LEFT JOIN "item" as "t4" ON "t4"."id" = "t0"."id" AND "t4"."id" = ? WHERE "t0"."id" = ? AND "t0"."id" = ? GROUP BY "t0"."id", "t0"."str" HAVING "t0"."id" = ? AND "t0"."id" = ? ORDER BY "t0"."id", "t0"."str" LIMIT 10 OFFSET 100`,
			"[1 2 6 7 8 9]",
		}
		fn(t, tableList, fromList, joinList, joinWhereList, valuesColumnList, valuesList, conflictList, setList, selectList, whereList, groupByList, havingList, orderByList, limit, offset, checkList)
	})
...
func TestQueryValue_GetSelectQuery(t *testing.T) {
	...
	t.Run("default", func(t *testing.T) {
		...
		offset := 100
		checkList := []string{
			`SELECT count("t0"."id"), "t0"."str" FROM "item" as "t0", "item" as "t1", "item" as "t2" INNER JOIN "item" as "t3" ON "t3"."id" = "t0"."id" AND "t3"."id" = ? LEFT JOIN "item" as "t4" ON "t4"."id" = "t0"."id" AND "t4"."id" = ? WHERE "t0"."id" = ? AND "t0"."id" = ? GROUP BY "t0"."id", "t0"."str" HAVING "t0"."id" = ? AND "t0"."id" = ? ORDER BY "t0"."id", "t0"."str" LIMIT 10 OFFSET 100`,
			"[1 2 6 7 8 9]",
		}
		fn(t, tableList, fromList, joinList, joinWhereList, valuesColumnList, valuesList, conflictList, setList, selectList, whereList, groupByList, havingList, orderByList, limit, offset, checkList)
	})
...
func TestQueryValue_GetSelectCountQuery(t *testing.T) {
	...
	t.Run("default", func(t *testing.T) {
		...
		offset := 100
		checkList := []string{
			`SELECT count(*) as count FROM "item" as "t0", "item" as "t1", "item" as "t2" INNER JOIN "item" as "t3" ON "t3"."id" = "t0"."id" AND "t3"."id" = ? LEFT JOIN "item" as "t4" ON "t4"."id" = "t0"."id" AND "t4"."id" = ? WHERE "t0"."id" = ? AND "t0"."id" = ? GROUP BY "t0"."id", "t0"."str" HAVING "t0"."id" = ? AND "t0"."id" = ? ORDER BY "t0"."id", "t0"."str" LIMIT 10 OFFSET 100`,
			"[1 2 6 7 8 9]",
		}
		fn(t, tableList, fromList, joinList, joinWhereList, valuesColumnList, valuesList, conflictList, setList, selectList, whereList, groupByList, havingList, orderByList, limit, offset, checkList)
	})
